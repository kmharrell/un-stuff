...
function twitter_bootstrap_js_alter(&$javascript) {
		$javascript['misc/jquery.js']['data'] = drupal_get_path('theme', 'twitter_bootstrap').'/bootstrap/js/jquery.js';
	}
...
function twitter_bootstrap_preprocess_views_view(&$vars) {
  $title_text = array();
