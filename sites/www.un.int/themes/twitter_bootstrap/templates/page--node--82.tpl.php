	...
	<div class="navbar-inner">
      ...
      <?php endif; ?>
  	 ...
  	 <section class="locator-menu">
  	  	<li class="topic-locator"><a href="<?php global $base_url; echo $base_url; ?>/topic-locator"></a></li>
  	  	<li class="committee-locator"><a href="<?php global $base_url; echo $base_url; ?>/committee-locator"></a></li>
  	  	<li class="personnel-locator"><a href="<?php global $base_url; echo $base_url; ?>/personnel-locator"></a></li>
  	  </section>
