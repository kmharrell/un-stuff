...
//Used by the SCORM/AICC wrappers
Conf.API_WRAPPER_DEBUG = false;
Conf.COOKIE_LIFETIME_IN_HOURS = 730 // 730 ~= 30 days

//"FLASH", "HTML5", "CUSTOM" or null (without quotes!) Audio object type
...
Conf.MAX_STEPIMAGE_WIDTH = 200;

//Reviewer/Comments (commenting feature)
Conf.ENABLE_COMMENTS = true;
Conf.REVIEWER_CLIENT_ID = "newfusion";
Conf.REVIEWER_PROJECT_ID = "s10aChangeorTerminateServiceContract_0.2.0.BETA";
