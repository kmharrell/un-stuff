/**
lang.js (dynamic)
Published by RWD uPerform 4.30.x.xx
...
Lang.SIM_END = "Close";
Lang.SIM_RESTART = "Replay Simulation";
...
Lang.COPYRIGHT = "Copyright © United Nations";
Lang.MODENAME_AUTO = "Show me";
Lang.MODENAME_SELFTEST = "Try it";
Lang.MODENAME_STANDARD = "Let's do it together";
Lang.MODENAME_ASSESSMENT = "Assessment Tutorial";
Lang.ENDMESSAGE_AUTO = "You have completed the simulation, click the Close button to exit the window.";
Lang.ENDMESSAGE_SELFTEST = "You have completed the lesson";
Lang.ENDMESSAGE_STANDARD = "You have completed the simulation, click the Close button to exit the window.";
