...
var ActionDragDrop = new Class({
	...
	animateCursor: function(stepCursor)
	{
		...
		var src = (this.cursor.file != "") ? engine.imagePath+this.cursor.file : engine.imagePath+stepCursor;
		...
		{
			curImg.src = this.src;
			engine.animator.animateCursorChain(self.step,curImg,x1,y1,x2,y2);
		}
		img.onerror = function()
		{
			Utils.debug.trace("Error: Cannot load cursor image: "+src);
